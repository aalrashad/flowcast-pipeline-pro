...
const NodeDetailsPanel = () => {
  ...
  const [tempData, setTempData] = useState<TempData>({
    ...
    width: selectedNode?.data?.width as number || 240,
    height: selectedNode?.data?.height as number || 200,
  });
